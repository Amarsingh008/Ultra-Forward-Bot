...
class Config:
    ...
    DATABASE_URI = environ.get("DATABASE", "Clusterf0")
    DATABASE_NAME = environ.get("DATABASE_NAME", "mongodb+srv://hcjs3k:EjzZN64q1wyjXdfi@cluster0.o6jzl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    ...
    FORCE_SUB_CHANNEL = environ.get("FORCE_SUB_CHANNEL", "0") 
